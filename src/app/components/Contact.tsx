        ...
        <div className="max-w-6xl mx-auto px-4">
          ...
          >
            <a
              ...
              className="flex items-center gap-2 p-4 bg-white dark:bg-gray-800 rounded-xl shadow-lg hover:shadow-xl transition-all hover:scale-105 border border-gray-200 dark:border-gray-700"
            >
          ...
          >
            <button
              ...
              className="px-8 py-4 bg-gradient-to-r from-blue-500 to-purple-600 text-white text-lg font-bold rounded-xl hover:from-blue-600 hover:to-purple-700 transition-all shadow-lg hover:shadow-2xl hover:scale-105"
            >
              Get In Touch
            </button>
          </motion.div>
